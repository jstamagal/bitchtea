module github.com/jstamagal/bitchtea

go 1.26.1

require (
	charm.land/catwalk v0.35.1
	...
	github.com/charmbracelet/x/mosaic v0.0.0-20260427100455-1ea3e7f8134f
...
require (
	...
	github.com/charmbracelet/x/cellbuf v0.0.16-0.20260427100455-1ea3e7f8134f // indirect
